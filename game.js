...
(function () {
  ...
  const ARENA_THEMES = [
    { id: 'night',   name: 'Midnight',  sky: 0x0a1228, turf: 0x2a7a44, fog: 0x0a1228, accent: 0x6c8cff },
    { id: 'sunset',  name: 'Sunset',    sky: 0x3a1a40, turf: 0x357a46, fog: 0x6a3a5a, accent: 0xffb347 },
    { id: 'ice',     name: 'Ice',       sky: 0x12304a, turf: 0x4a8aaa, fog: 0x9fd6ff, accent: 0x8fe3ff },
    { id: 'neon',    name: 'Neon',      sky: 0x12082a, turf: 0x4a2a9a, fog: 0x12082a, accent: 0xff2bd6 },
    { id: 'day',     name: 'Day',       sky: 0x7ab0e0, turf: 0x3a9a4e, fog: 0xbfe3ff, accent: 0xffffff },
    { id: 'volcano', name: 'Volcano',   sky: 0x2a0d08, turf: 0x3a2420, fog: 0x2a0d08, accent: 0xff3300 },
    { id: 'aquatic', name: 'Aquatic',   sky: 0x024a5a, turf: 0x0a8a9a, fog: 0x024a5a, accent: 0x00e5ff },
    { id: 'orbital', name: 'Orbital',   sky: 0x05071a, turf: 0x2a3a5a, fog: 0x05071a, accent: 0x00b3ff },
    { id: 'desert',  name: 'Desert',    sky: 0xc38d5f, turf: 0x9a8050, fog: 0xd8a070, accent: 0xff9e4f },
    { id: 'synth',   name: 'Synthwave', sky: 0x33105a, turf: 0x3a1a6a, fog: 0x33105a, accent: 0xff10f0 },
    { id: 'champ',   name: 'Champions', sky: 0x15151f, turf: 0x4a6a7a, fog: 0x15151f, accent: 0xffd24a }
  ];
  const MUTATORS = {
